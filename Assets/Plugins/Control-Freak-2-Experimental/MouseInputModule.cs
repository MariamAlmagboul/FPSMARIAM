...
namespace ControlFreak2
{
    ...
    public class MouseInputModule : UnityEngine.EventSystems.PointerInputModule
    {
        ...
        public override void UpdateModule()
        {
            ...
            m_MousePosition = ControlFreak2.CF2Input.mousePosition;
        }
        ...
        public override bool ShouldActivateModule()
        {
            ...
            shouldActivate |= ControlFreak2.CF2Input.GetMouseButtonDown(0);
        ...
        public override void ActivateModule()
        {
            base.ActivateModule();
            m_MousePosition = ControlFreak2.CF2Input.mousePosition;
            m_LastMousePosition = ControlFreak2.CF2Input.mousePosition;
